...
class MessageInline(admin.TabularInline):
    model = Message
    extra = 0
    readonly_fields = ('sender', 'text', 'product', 'is_read', 'reaction', 'is_favorite', 'created_at')
    fields = ('sender', 'text', 'product', 'is_read', 'reaction', 'is_favorite', 'created_at')
...
class ConversationAdmin(admin.ModelAdmin):
    list_display = ('id', 'user1', 'user2', 'status_badge', 'requested_by', 'updated_at', 'created_at')
...
class MessageAdmin(admin.ModelAdmin):
    list_display = ('id', 'conversation', 'sender', 'short_text', 'has_product', 'is_read', 'created_at')
    ...
    readonly_fields = ('conversation', 'sender', 'product', 'created_at')
