...
export const chatAPI = {
  ...
  markDelivered: (conversationId, data = {}) => api.post(`/chat/conversations/${conversationId}/mark_delivered/`, data, { authRequired: true }),
  ...
  getUnreadCount: (config = {}) => api.get('/chat/conversations/unread_summary/', { ...config, authRequired: true }),
  getPushPublicKey: (config = {}) => api.get('/chat/notifications/push_public_key/', { ...config, authRequired: true }),
...
export const supportAPI = {
  ...
  getMessages: (id, params) => api.get(`/support/conversations/${id}/messages/`, { authRequired: true, params }),
