...
import { formatRelativeDate, formatTime } from '../lib/formatDate';
...
export default function SupportChatPage() {
  ...
  const createConversation = async (department) => {
    if (busy) return;
    setBusy(true);
    try {
