...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setCaptchaRequired((current) => current || Boolean(err.captchaRequired));
      setCaptchaToken('');
              ...
              <div className="flex justify-center">
                {import.meta.env.VITE_HCAPTCHA_SITE_KEY ? (
                  <HCaptchaWidget
                    ...
                    onError={() => setError('بارگذاری CAPTCHA ناموفق بود؛ دوباره تلاش کنید.')}
                  />
                ) : (
                  <p className="text-sm text-destructive">
                    کلید عمومی CAPTCHA تنظیم نشده است.
                  </p>
                )}
              </div>
            )}
